...
def get_driver(headless=True, mobile=False, EXECUTOR_TIMEOUT=60, proxy_host=None, run_js:bool=False) -> webdriver.Chrome :
...
render = SeleniumRender(headless=False)
try :
    render.driver.get('https://www.tiktok.com/@fcbayern')
    print("============")
    render.driver.refresh()
    print("============")
finally :
    render.close()
