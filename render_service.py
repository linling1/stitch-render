...
class RenderService:
    ...
    def __init__(self, chrome_path:str=None, version:str=None) -> None:
        self.chrome_path = chrome_path
        self.version = version


    def render(self, url:str, user_agent:str=None, cookies:dict=None, proxy_url:str=None, loading_page_timeout:int=EXECUTOR_TIMEOUT, refresh:bool=False, javascript:str=None, disable_proxy:bool=False, delay:float=None, width:int=1440, height:int=718) -> str :
        try :
            ...
            with SeleniumRender(proxy_host=proxy_host, user_agent=user_agent, loading_page_timeout=loading_page_timeout, disable_proxy=disable_proxy, width=width, height=height, chrome_path=self.chrome_path, version=self.version) as driver :
                if cookies :
                    cookie_param = []
                    for k, v in cookies :
