...
chrome.setUpEvents = async function (tab) {
	...
	Network.requestWillBeSent((params) => {
		...
		let host = new URL(params.request.url).host;
		// if (host != "www.msn.com") {
		...
		if (tab.prerender.logRequests || this.options.logRequests) util.log('+', tab.prerender.numRequestsInFlight, params.request.url, params.request.isSameSite, host, params.request.method, params.request.headers);
